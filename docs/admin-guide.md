...
3. Log in as the platform admin (email/password, **Forgot password?** on the sign-in page, or **Continue with Authentik** after you enable OIDC). RelayHorizon opens the **Portal** (`/portal`), not the tenant console. The header profile menu can change your display name and optional picture.
