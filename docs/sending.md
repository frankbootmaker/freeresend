...
## Caps, Abuse, and freeze

Sends that are not `failed` count against hour / day / month caps. New tenants start in the **probation** pool (**5,000** / **20,000** / **100,000**). Portal Customers → Manage can assign **shared**, **bring-your-own**, or **dedicated** and override those caps.
