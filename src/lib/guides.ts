    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The tenant Abuse tab is read-only sending health (pool, caps, 24-hour bounce and complaint rates, suppressions, freeze). If the SES webhook freezes sending, unfreeze from Manage. Tenants cannot unfreeze themselves.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'A 24-hour bounce rate of 10% over at least 50 messages, or 3 complaints (or 0.1% over at least 100 messages), freezes sending (HTTP 423). Unfreeze from Customers → Manage. This is not a card-billing freeze.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Die Mandanten-Seite Missbrauch ist nur Lesen (Pool, Grenzen, 24-Stunden-Bounce- und Beschwerderaten, Unterdrückungen, Sperre). Wenn der SES-Webhook den Versand sperrt, entsperren Sie in Verwalten. Mandanten können das nicht selbst.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Eine 24-Stunden-Bounce-Rate von 10 % bei mindestens 50 Nachrichten oder 3 Beschwerden (oder 0,1 % bei mindestens 100) sperrt den Versand (HTTP 423). Entsperren unter Kunden → Verwalten. Das ist keine Karten-Sperre.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'A bérlő Visszaélés lapja csak olvasható küldési állapot (pool, plafonok, 24 órás visszapattanás és panasz, tiltások, fagyasztás). Ha a SES webhook befagyasztja a küldést, a kezelésben oldja fel. A bérlők maguk nem oldhatják fel.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'A 24 órás 10%-os visszapattanás legalább 50 üzenetnél, vagy 3 panasz (illetve 0,1% legalább 100 üzenetnél) befagyasztja a küldést (HTTP 423). Feloldás: Ügyfelek → Kezelés. Ez nem kártyás befagyasztás.',
