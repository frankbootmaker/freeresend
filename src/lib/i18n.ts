...
const en: Dict = {
  ...
  login: {
    ...
    title: 'Sign in',
    lead:
      'One console for everyone. Platform admins open the portal; tenant members land in their organization.',
    email: 'Work email',
    password: 'Password',
    submit: 'Sign in',
  ...
  register: {
    ...
    lead: 'Sets up a new tenant and the first owner account for the console.',
    org: 'Organization',
    ...
    useExisting: 'Already have an account? Sign in',
  ...
  sending: {
    ...
    resendBaseHint: 'The SDK appends /emails. Do not set this to /api/emails.',
    ingressPolicy: 'Ingress policy',
    egressConnector: 'Egress connector',
    https: 'HTTPS',
    smtp: 'SMTP',
    both: 'Both',
    publicApiUrl: 'Resend base URL',
    smtpHost: 'SMTP host',
    smtpPort: 'SMTP port',
    tlsMode: 'TLS mode',
...
const de: Dict = {
  ...
  login: {
    ...
    title: 'Anmelden',
    lead:
      'Eine Konsole für alle. Plattformadministratoren öffnen das Portal; Mandantenmitglieder ihre Organisation.',
    ...
    createAccount: 'Organisation anlegen',
  ...
  register: {
    ...
    lead: 'Legt einen neuen Mandanten und das erste Eigentümerkonto für die Konsole an.',
    org: 'Organisationsname',
    operatorName: 'Ihr Name',
    slug: 'Mandanten-Slug',
    ...
    useExisting: 'Bereits ein Konto? Anmelden',
    namePlaceholder: 'Mara Varga',
    emailPlaceholder: 'sie@firma.test',
    passwordPlaceholder: 'Mindestens 12 Zeichen',
  ...
  sending: {
    ...
    resendBaseHint: 'Das SDK hängt /emails an. Nicht auf /api/emails setzen.',
    ingressPolicy: 'Eingangsrichtlinie',
    egressConnector: 'Ausgangsanschluss',
    https: 'HTTPS',
    smtp: 'SMTP',
    both: 'Beides',
    publicApiUrl: 'Resend-Basis-URL',
    smtpHost: 'SMTP-Host',
    smtpPort: 'SMTP-Port',
    tlsMode: 'TLS-Modus',
...
const hu: Dict = {
  ...
  login: {
    ...
    title: 'Belépés',
    lead:
      'Egy konzol mindenkinek. A platformadminisztrátorok a portálra, a bérlőtagok a szervezetükre jutnak.',
    email: 'E-mail-cím',
    password: 'Jelszó',
    submit: 'Belépés',
    submitting: 'Belépés…',
    ...
    createAccount: 'Szervezet létrehozása',
  ...
  register: {
    ...
    lead: 'Új bérlőt és az első tulajdonosi fiókot hozza létre a konzolhoz.',
    org: 'Szervezet neve',
    operatorName: 'Az Ön neve',
    slug: 'Bérlő-slug',
    ...
    useExisting: 'Már van fiókja? Belépés',
    namePlaceholder: 'Mara Varga',
    emailPlaceholder: 'on@ceg.test',
    passwordPlaceholder: 'Legalább 12 karakter',
  ...
  sending: {
    ...
    resendBaseHint: 'Az SDK a /emails útvonalat fűzi hozzá. Ne állítsa /api/emails-re.',
    ingressPolicy: 'Bejövő szabály',
    egressConnector: 'Kimenő csatlakozó',
    https: 'HTTPS',
    smtp: 'SMTP',
    both: 'Mindkettő',
    publicApiUrl: 'Resend alap-URL',
    smtpHost: 'SMTP-gép',
    smtpPort: 'SMTP-port',
    tlsMode: 'TLS-mód',
