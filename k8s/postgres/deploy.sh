...
# RelayHorizon PostgreSQL K8s Deployment Script

set -e

echo "🚀 RelayHorizon PostgreSQL Kubernetes Deployment"
echo "=============================================="
echo ""
...
kubectl wait --for=condition=ready pod/postgres-0 -n relayhorizon --timeout=300s
...
# Show status
echo "📊 Current Status:"
kubectl get all -n relayhorizon -l app=postgres

echo ""
echo "💾 Storage:"
kubectl get pvc -n relayhorizon postgres-pvc

echo ""
echo "🔍 PostgreSQL Pod Logs (last 10 lines):"
kubectl logs -n relayhorizon postgres-0 --tail=10
...
echo ""
echo "2. Restart RelayHorizon app to use new database:"
echo "   kubectl rollout restart deployment/relayhorizon -n relayhorizon"
echo ""
echo "3. Verify database connection:"
echo "   kubectl logs -n relayhorizon deployment/relayhorizon | grep -i database"
echo ""
echo "4. Access database directly (optional):"
echo "   kubectl exec -it -n relayhorizon postgres-0 -- psql -U relayhorizon -d relayhorizon"
echo ""
